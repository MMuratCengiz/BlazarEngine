...
FOREACH (CORE_BOOST_LIB IN LISTS CORE_BOOST_LIBS)
    ...
    IF (${BLAZAR_INSTALL_LIBS})
        INSTALL(DIRECTORY ${PROJECT_SOURCE_DIR}/external/boost/libs/${CORE_BOOST_LIB}/include/ DESTINATION ${BLAZAR_INSTALL_LOCATION}include)
    ENDIF()
ENDFOREACH ()
...
FOREACH (PLATFORM_BOOST_LIB IN LISTS PLATFORM_BOOST_LIBS)
    ...
    IF (${BLAZAR_INSTALL_LIBS})
        INSTALL(DIRECTORY ${PROJECT_SOURCE_DIR}/external/boost/libs/${PLATFORM_BOOST_LIB}/include/ DESTINATION ${BLAZAR_INSTALL_LOCATION}include)
    ENDIF()
ENDFOREACH ()
...
FOREACH (REQUESTED_BOOST_LIB IN LISTS REQUESTED_BOOST_LIBS)
    ...
    IF (${BLAZAR_INSTALL_LIBS})
        INSTALL(DIRECTORY ${PROJECT_SOURCE_DIR}/external/boost/libs/${REQUESTED_BOOST_LIB}/include/ DESTINATION ${BLAZAR_INSTALL_LOCATION}include)
    ENDIF()
ENDFOREACH ()