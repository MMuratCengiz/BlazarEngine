...
IF (${BLAZAR_INSTALL_LIBS})
    INSTALL(FILES "${PROJECT_SOURCE_DIR}/external/stb/" DESTINATION ${BLAZAR_INSTALL_LOCATION}include)
    INSTALL(FILES "${PROJECT_SOURCE_DIR}/external/miniz/" DESTINATION ${BLAZAR_INSTALL_LOCATION}include)
    INSTALL(FILES "${PROJECT_SOURCE_DIR}/external/vma/" DESTINATION ${BLAZAR_INSTALL_LOCATION}include)
    INSTALL(FILES "${PROJECT_SOURCE_DIR}/external/tinygltf/" DESTINATION ${BLAZAR_INSTALL_LOCATION}include)
    INSTALL(FILES "${PROJECT_SOURCE_DIR}/external/glm/" DESTINATION ${BLAZAR_INSTALL_LOCATION}include)
ENDIF()
