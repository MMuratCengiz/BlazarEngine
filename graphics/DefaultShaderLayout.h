...
public:
    DefaultShaderLayout() {
        ...
        descriptorSetBindings = {
                { .index = 0, .type = vk::DescriptorType::eUniformBuffer, .binding = uniformDesc, .size = MVP::fullSize() },
                { .index = 1, .type = vk::DescriptorType::eCombinedImageSampler, .binding = textureDesc },
        };
    };
};
