...
SCameraLoader::SCameraLoader( std::shared_ptr< InstanceContext > context, std::shared_ptr< Scene::Camera > camera )
...
std::pair< vk::Buffer, vma::Allocation > &SCameraLoader::getBuffer( ) {
    return cameraBuffer;
}

SCameraLoader::~SCameraLoader( ) {
