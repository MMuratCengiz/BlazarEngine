...
#include <BlazarGraphics/VulkanBackend/VulkanCommandExecutor.h>

using namespace ENGINE_NAMESPACE::Graphics;

VulkanCommandExecutor::VulkanCommandExecutor( VulkanContext * context ) : context( context )
{
    vk::CommandPoolCreateInfo commandPoolCreateInfo { };

    commandPoolCreateInfo.queueFamilyIndex = this->context->queueFamilies[ QueueType::Graphics ].index;
    commandPoolCreateInfo.flags = vk::CommandPoolCreateFlagBits::eResetCommandBuffer;

    commandPool = this->context->logicalDevice.createCommandPool( commandPoolCreateInfo );
}

std::shared_ptr< BeginCommandExecution > VulkanCommandExecutor::startCommandExecution( )
{
...
BeginCommandExecution::BeginCommandExecution( VulkanCommandExecutor *executor ) : executor( executor )
{ }
